  ...
  <section className="about" id="about">
    <div className="about-me">
      ...
      <p className="paragraph about-para">
        My journey in the world of programming began in 2022, when I ventured into freelancing, then a contract with Reboth Finance and an Associate Software Engineer position at Decagon in 2023. Since then, I have had the opportunity to work on a wide range of projects, honing my skills and expanding my knowledge along the way. I have worked with various clients, both independently and as part of a team, to deliver innovative and user-friendly websites and mobile applications.
      </p>
